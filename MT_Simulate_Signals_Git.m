...
%%
if uniform_sampling
    save(['/scratch/kl3141/MRF_matlab/MRF_CRB/Git_results/Uniform/ijob_', num2str(ijob)], 'm0s', 'T1', 'T2f', 'R', 'T2s', 's', 'CRB_all');
else
    save(['/scratch/kl3141/MRF_matlab/MRF_CRB/Git_results/Gaussian/ijob_', num2str(ijob)], 'm0s', 'T1', 'T2f', 'R', 'T2s', 's', 'CRB_all');
end
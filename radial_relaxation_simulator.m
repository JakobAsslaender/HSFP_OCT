...
%     0,... 
%     0;...
%     (theta*sin(B1*theta)*(exp(-T*(cos(B1*theta)^2/T1 + sin(B1*theta)^2/T2)) - 1))/(cos(B1*theta)^2 + (T1*sin(B1*theta)^2)/T2) - (cos(B1*theta)*(exp(-T*(cos(B1*theta)^2/T1 + sin(B1*theta)^2/T2)) - 1)*(2*theta*cos(B1*theta)*sin(B1*theta) - (2*T1*theta*cos(B1*theta)*sin(B1*theta))/T2))/(cos(B1*theta)^2 + (T1*sin(B1*theta)^2)/T2)^2 - (T*exp(-T*(cos(B1*theta)^2/T1 + sin(B1*theta)^2/T2))*cos(B1*theta)*((2*theta*cos(B1*theta)*sin(B1*theta))/T1 - (2*theta*cos(B1*theta)*sin(B1*theta))/T2))/(cos(B1*theta)^2 + (T1*sin(B1*theta)^2)/T2),...
...
y =         r         .* repmat(sin(B1(n)*theta.'), [1 3 Nspin]);

% y =  y(1:2:end,:);
% z =  z(1:2:end,:);
% if nargout > 2
%     dy = dy(1:2:end,1:2:end,:);
%     dz = dz(1:2:end,1:2:end,:);
% end
